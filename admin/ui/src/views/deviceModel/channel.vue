<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="!info.num" label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="150px">
...
<script>
  import {getInfo,updateChannel} from '@/api/deviceModel'
